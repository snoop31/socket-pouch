...
function SocketPouch(opts, callback) {
  ...
  function createNewSocket() {
    ...
    var socket = api._socket = io(opts.url, opts.socketOptions || {});
  ...
  api.request = adapterFun('request', function (req, callback) {
    var url = req.url;
    var method = req.method;
    var type;
    if(url == '_index'){
      type = {'POST':'createIndex', 'GET':'getIndexes', 'DELETE': 'deleteIndex'}[method];
    }else if(url == '_find'){
      type = 'find';
    }
    var opts = [];
    ...
    sendMessage(type, opts, function (err, res) {
      if (err) {
        return callback(err);
      }
      if (opts.attachments && opts.binary) {
...
},{"../shared/buffer":11,"../shared/errors":13,"../shared/isBinaryObject":14,"../shared/utils":17,"./../shared/uuid":18,"./base64":3,"./readAsBinaryString":9,"./utils":10,"_process":60,"blob-util":23,"debug":31,"pouchdb-promise":58,"socket.io-client":61}],9:[function(_dereq_,module,exports){
'use strict';
...
},{"../shared/utils":17,"./base64StringToBlobOrBuffer":4,"_process":60,"debug":31}],11:[function(_dereq_,module,exports){
...
},{"inherits":39}],14:[function(_dereq_,module,exports){
'use strict';
...
},{"./buffer":11,"./parse-message":15,"./pouchdb-clone":16,"_process":60,"inherits":39,"pouchdb-binary-util":57,"pouchdb-promise":58}],18:[function(_dereq_,module,exports){
"use strict";
...
},{"blob":24,"native-or-lie":54}],24:[function(_dereq_,module,exports){
(function (global){
/**
...
},{"base64-js":22,"ieee754":36,"isarray":27}],27:[function(_dereq_,module,exports){
...
},{"./debug":32,"_process":60}],32:[function(_dereq_,module,exports){
...
},{"ms":53}],33:[function(_dereq_,module,exports){
(function (Buffer){
/* global Blob File */
...
},{"buffer":26,"isarray":34}],34:[function(_dereq_,module,exports){
arguments[4][27][0].apply(exports,arguments)
},{"dup":27}],35:[function(_dereq_,module,exports){
...
},{"./INTERNAL":40,"./handlers":42,"./promise":44,"./reject":47,"./resolve":48}],42:[function(_dereq_,module,exports){
'use strict';
...
},{"./resolveThenable":49,"./states":50,"./tryCatch":51}],43:[function(_dereq_,module,exports){
...
},{"./all":41,"./promise":44,"./race":46,"./reject":47,"./resolve":48}],44:[function(_dereq_,module,exports){
'use strict';
...
},{"./INTERNAL":40,"./queueItem":45,"./resolveThenable":49,"./states":50,"./unwrap":52}],45:[function(_dereq_,module,exports){
'use strict';
var handlers = _dereq_('./handlers');
var unwrap = _dereq_('./unwrap');
...
},{"./handlers":42,"./unwrap":52}],46:[function(_dereq_,module,exports){
'use strict';
var Promise = _dereq_('./promise');
var reject = _dereq_('./reject');
var resolve = _dereq_('./resolve');
...
},{"./INTERNAL":40,"./handlers":42,"./promise":44,"./reject":47,"./resolve":48}],47:[function(_dereq_,module,exports){
'use strict';
...
},{"./INTERNAL":40,"./handlers":42,"./promise":44}],48:[function(_dereq_,module,exports){
'use strict';
...
},{"./INTERNAL":40,"./handlers":42,"./promise":44}],49:[function(_dereq_,module,exports){
'use strict';
var handlers = _dereq_('./handlers');
var tryCatch = _dereq_('./tryCatch');
...
},{"./handlers":42,"./tryCatch":51}],50:[function(_dereq_,module,exports){
...
},{"./handlers":42,"immediate":37}],53:[function(_dereq_,module,exports){
/**
 * Helpers.
 */
...
},{"lie":43}],55:[function(_dereq_,module,exports){
/**
...
},{"lie":59}],59:[function(_dereq_,module,exports){
'use strict';
var immediate = _dereq_('immediate');
...
},{"immediate":37}],60:[function(_dereq_,module,exports){
...
},{"./manager":62,"./socket":64,"./url":65,"debug":67,"socket.io-parser":82}],62:[function(_dereq_,module,exports){
...
},{"./on":63,"./socket":64,"backo2":20,"component-bind":28,"component-emitter":29,"debug":67,"engine.io-client":69,"indexof":38,"socket.io-parser":82}],63:[function(_dereq_,module,exports){
...
},{"./on":63,"component-bind":28,"component-emitter":29,"debug":67,"has-binary2":33,"parseqs":55,"socket.io-parser":82,"to-array":87}],65:[function(_dereq_,module,exports){
(function (global){
...
},{"debug":67,"parseuri":56}],66:[function(_dereq_,module,exports){
/**
...
},{"./debug":68,"_process":60}],68:[function(_dereq_,module,exports){
...
},{"ms":53}],69:[function(_dereq_,module,exports){
...
},{"./transport":71,"./transports/index":72,"component-emitter":29,"debug":67,"engine.io-parser":78,"indexof":38,"parseqs":55,"parseuri":56}],71:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":29,"engine.io-parser":78}],72:[function(_dereq_,module,exports){
(function (global){
/**
 * Module dependencies
 */
...
},{"./polling":75,"component-inherit":30}],74:[function(_dereq_,module,exports){
(function (global){
/**
 * Module requirements.
 */
...
},{"./polling":75,"component-emitter":29,"component-inherit":30,"debug":67,"xmlhttprequest-ssl":77}],75:[function(_dereq_,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":71,"component-inherit":30,"debug":67,"engine.io-parser":78,"parseqs":55,"xmlhttprequest-ssl":77,"yeast":88}],76:[function(_dereq_,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":71,"component-inherit":30,"debug":67,"engine.io-parser":78,"parseqs":55,"ws":25,"yeast":88}],77:[function(_dereq_,module,exports){
(function (global){
...
},{"has-cors":35}],78:[function(_dereq_,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"./keys":79,"./utf8":80,"after":19,"arraybuffer.slice":66,"base64-arraybuffer":21,"blob":24,"has-binary2":33}],79:[function(_dereq_,module,exports){
...
},{"./binary":81,"./is-buffer":83,"component-emitter":29,"debug":84,"isarray":86}],83:[function(_dereq_,module,exports){
(function (global){
...
},{"./debug":85,"_process":60,"dup":67}],85:[function(_dereq_,module,exports){
arguments[4][68][0].apply(exports,arguments)
},{"dup":68,"ms":53}],86:[function(_dereq_,module,exports){
arguments[4][27][0].apply(exports,arguments)
},{"dup":27}],87:[function(_dereq_,module,exports){
